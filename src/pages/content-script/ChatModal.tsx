...
export default observer((props: { onClose: () => void; show: boolean }) => {
  ...
  async function initConfigFromLocal() {
    if (chatGPTStore.sessionsInited.get('default')) return;
    ...
    >
      ...
      >
        <div className={styles['g-bg']}>
          <div className={styles['g-polygon-1']}></div>
          <div className={styles['g-polygon-2']}></div>
          <div className={styles['g-polygon-3']}></div>
        </div>
